...
import com.scwang.smartrefresh.layout.footer.FooterLoadLayout;
import com.scwang.smartrefresh.layout.header.HeadLoadLayout;
...
//                    setRefreshHeader(new BezierRadarHeader(thisView.getContext()));
                    setRefreshHeader(new HeadLoadLayout(thisView.getContext()));
                }
            }
...
//                    setRefreshFooter(new BallPulseFooter(thisView.getContext()));
                    setRefreshFooter(new FooterLoadLayout(thisView.getContext()));
                    mEnableLoadMore = old;
                }
            } else {
                mEnableLoadMore = mEnableLoadMore || !mManualLoadMore;
